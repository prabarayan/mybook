...
class Hybrid_Providers_Facebook extends Hybrid_Provider_Model
{
	...
	public $scope = "email, user_about_me, user_birthday, user_hometown, user_website, publish_actions,user_friends,read_custom_friendlists";
...
//		}
	...
	*/
	...
	{
		try{ 
			$response = $this->api->api('/me/friendlists'); 
		}
		catch( FacebookApiException $e ){
                    log_message('debug', 'User contacts request failed!');
			throw new Exception( "User contacts request failed! {$this->providerId} returned an error: $e" );
		} 
 
		if( ! $response || ! count( $response["data"] ) ){
                    log_message('debug', 'User contacts request failed!not');
			return ARRAY();
