                    ...
                    <div class="module">
                        ...
                        <form class="form-horizontal row-fluid" style="border-top:0px;" name="charityForm" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>charity/editCharity">
                            ...
                            <div class="control-group span6" style="padding:15px;">
                                ...
                                <label class="control-label" for="basicinput" style="padding:10px;">Charity Category:</label>
                                <div class="controls">
                                    <select id="basicinput" class="span10" name="charity_category">
                                        <option value="none">--Select--</option>
                                         <?php
//                                         $sel='';
                                        foreach ($cate as $value) {
//                                            if($editCharity[0]->charity_category = $value->cate_id){
//                                                $sel="selected";
//                                            }else{
//                                                 $sel='';
//                                            }
                                            $selected = ($editCharity[0]->charity_category == $value->cate_id)? "selected='selected'":''; 
                                            echo "<option value=".$value->cate_id." $selected>".$value->cate_name."</option>";
                                        }
                                        ?>
                                       
                                    </select>
                                    <p id="charity_category" class="error"></p>
                                </div>
                                <label class="control-label" for="basicinput" style="padding:10px;">Pin Code:</label>
                                <div class="controls">
                                    <input type="text" id="basicinput" class="span10" name="pincode" value="<?php echo $editCharity[0]->pincode ?>">
                                    <p id="pincode" class="error"></p>
                                </div>
                            </div>
                            <div class="control-group span6" style="margin:0px; padding:15px;">
                                ...
                                <label class="control-label" for="basicinput" style="padding:10px;">Location:</label>
                                <div class="controls">
                                    <input type="text" id="basicinput" class="span10" name="location" value="<?php echo $editCharity[0]->location ?>">
...
//validation for charity
    function charityValidation() {
        ...
        if (document.charityForm.charity_category.value == "none") {
            document.getElementById("charity_category").innerHTML = "Please select category";
            document.charityForm.address.focus();
            return false;
        }
        if (document.charityForm.pincode.value == ""||document.charityForm.pincode.value == "0") {
            document.getElementById("pincode").innerHTML = "Please enter pincode";
            document.charityForm.address.focus();
            return false;
        }
        if (document.charityForm.location.value == "") {
            document.getElementById("location").innerHTML = "Please enter location";
            document.charityForm.address.focus();
            return false;
        }
        return true;
